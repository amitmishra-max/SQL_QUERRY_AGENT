...
async def ask_question(
    ...
    try:
        ...
        print(f"[Query] SQL generated by provider: {llm_provider}")
        ...
        analysis_obj = None
        try:
            analysis_response = llm_service.analyze_query_results(
                request.question or "", result_rows or []
            )
            if inspect.isawaitable(analysis_response):
                analysis_response = await analysis_response
