...
class Settings(BaseSettings):
    ...
    # If both are set, prefer GOOGLE_* for backward compatibility with earlier env naming.
    GOOGLE_API_KEY: str = os.getenv("GOOGLE_API_KEY") or os.getenv("GEMINI_API_KEY", "")
    GEMINI_API_KEY: str = GOOGLE_API_KEY

    GOOGLE_MODEL: str = os.getenv("GOOGLE_MODEL") or os.getenv("GEMINI_MODEL", "gemini-2.5-flash")
    GEMINI_MODEL: str = os.getenv("GEMINI_MODEL") or GOOGLE_MODEL
